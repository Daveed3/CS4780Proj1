...
public class Cracking {
	...
	public static void main(String[] args) {		
		...
		ArrayList<byte[]> encryptedLetters = new ArrayList<byte[]>();

		//CRYPTOGRAPHY
		// Each letter is a 2^5 = 32
		// Or what if it is CRYPTO GRAPHY
//		String string = "CRYPTOGRAPHY";
//		for (int i=0; i<string.length(); i++) {
//			// Turn into CASCII
//			byte[] casciiLetter = cascii.Convert(string.charAt(i) + "");
//
//			//Encrypt the letter
//			byte[] encryptedLetter = sdes.Encrypt(rawkey, casciiLetter);
...
//			byte[] rawkeyMsg1 = stringTo10BitArray(currentIter);
//			currentIter = addBit(currentIter);
//			
//			for (int i=0; i<msg1.length()/8; i++) {
//				byte[] msg18bit = new byte[8];
//				for (int j=0; j<msg18bit.length; j++) {
//					if (j < 8) {
//						msg18bit[j] = (byte)(msg1.charAt(j + (i*5)) -48);	
//					} else {
//						msg18bit[j] = 0;
//					}
//				}
//				
////				sdes.printArray(sdes.Decrypt(rawkey, msg18bit));
//				System.out.print(cascii.Convert(sdes.subArray(sdes.Decrypt(rawkeyMsg1, msg18bit), 0, 4)) );
//				
//			}	
//			System.out.println();
//		}
